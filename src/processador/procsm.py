...
## Junho de 2023
"""Processador para Salário Maternidade"""

import pandas as pd
from arquivo import ArquivoPrismaSaida
from os import path
from tarefa import TarefaSalMaternidade
...
class ProcessadorSalMaternidade(Processador):
    ...
    def __init__(self, base_dados):      
        ...
        self.lista = [TarefaSalMaternidade]
    ...
    def processar_dados(self) -> None:
        ...
        for i in range(tamanho):
            tarefa = TarefaSalMaternidade(self.base_dados, i)
