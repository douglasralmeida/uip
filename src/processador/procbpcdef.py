...
## Junho de 2023
"""Processador para Benefício Assistencial ao Deficiente"""

from tarefa import TarefaBenAssDeficiente
...
class ProcessadorBenAssDeficiente(Processador):
    """Classe para o processador de Benefício Assistencial ao Deficiente."""
    def __init__(self, base_dados):      
        ...
        self.lista = [TarefaBenAssDeficiente]
    ...
    def processar_dados(self) -> None:
        ...
        for i in range(tamanho):
            tarefa = TarefaBenAssDeficiente(self.base_dados, i)
